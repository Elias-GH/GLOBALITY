...
<a class="returnMenu" onclick="history.back(-1)"><i class="fas fa-undo"></i></a>
...
<div class="modifEvent" id="blockModif" style="display: none; opacity: 0;">
    ...
    <form class="modifEvent" action="#" method="post">
        ...
        <div class="inputBox" style="width: 80%; margin-left: 30px;">
            <textarea name="descriptionEvent" id="descriptionEvent" placeholder="description (255 caractères)" maxlength="255"><?= $_GET['description'] ?></textarea>
        </div>
