<?php
    ...
    if (empty($_SESSION)) {
        ...
        if (isset($_GET['year'])) {
            if ($_GET['year'] < 2) $_GET['year'] = 2;
            if ($_GET['year'] > 4) $_GET['year'] = 4;
        }
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#addModel').on('change', function(e) {
            var files = $(this)[0].files;
            $('#label-addModel').text(files.length + " fichier");
        });
    });
</script>
    ...
    <?php } else if ($_GET['show'] == 'reportFiles') { ?>
            ...
            <div class="addReport">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="file" name="addModel" id="addModel" value="Selectionner le modèle" style="display: none">
                    <label for="addModel" id="label-addModel" class="fileModel">Modèle</label>
